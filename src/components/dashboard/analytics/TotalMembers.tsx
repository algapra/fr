...
const TotalMembers: React.FC<TotalMembersProps> = ({dataCount}) => {

  return (
    <Card>
      <CardContent >
        <CustomAvatar skin='light' color='info' variant='rounded' sx={{ mr: 1.5, mb:1.5, padding: '0.5rem', height: 50, width: 50 }}>
          <Icon icon='tabler:chart-bar' fontSize='5rem' />
        </CustomAvatar>
        <Box sx={{ gap: 2, mb: 1.5, display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <div>
            <Typography sx={{ fontWeight: 600, fontSize: 18}}>Total Member</Typography>
          </div>
        </Box>
