...
export class MakeRelationCompanyToUser1715591285867
  implements MigrationInterface
{
  name = 'MakeRelationCompanyToUser1715591285867';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`users\` ADD \`companyId\` varchar(36) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`users\` ADD UNIQUE INDEX \`IDX_6f9395c9037632a31107c8a9e5\` (\`companyId\`)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_6f9395c9037632a31107c8a9e5\` ON \`users\` (\`companyId\`)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`REL_6f9395c9037632a31107c8a9e5\` ON \`users\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`users\` DROP INDEX \`IDX_6f9395c9037632a31107c8a9e5\``,
    );
