...
//---------------
export type DataDepartmentType = {
  department: string
}

// Data role page
//---------------
export type DataRoleType = {
  id: number
  department: string
  role: string
  room_access: string
...
// Data member page
//---------------
export type DataMemberType = {
  nik: string
  role: string
  attendances?: string | undefined
  statuses: string
  avatar?: string
  fullName: string
}

export type RecordPresensiType = {
  presense: string
  date: string,
  in: string,
  out: string,
